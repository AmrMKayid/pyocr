...
from .pytorchocr_utility import AnalysisConfig
from pyocr.pytorchocr.data import create_operators, transform
from pyocr.pytorchocr.postprocess import build_post_process
import logging
...
class TextDetector(BaseOCRV20):
    def __init__(self, args, **kwargs):
        ...
        if self.det_algorithm == "DB":
            ...
            logging.error("unknown det_algorithm:{}".format(self.det_algorithm))
            sys.exit(0)
        ...
        network_config = AnalysisConfig(self.weights_path, self.yaml_path)
